    ...
    <div class="row">
      <div class="col-12">
        <div class="mb-5">
          ...
          <p class="text-center m-0">Don't have an account? <a href="sign-up">Sign up</a></p>
        </div>
      </div>
    </div>
      ...
      <div class="col-12 col-lg-10 col-xl-8">
        <div class="row gy-5 justify-content-center">
          ...
          <div class="col-12 col-lg-2 d-flex align-items-center justify-content-center gap-3 flex-lg-column">
            <div class="bg-dark h-100 d-none d-lg-block" ></div>
            <div class="bg-dark w-100 d-lg-none" ></div>
            <div>or</div>
            <div class="bg-dark h-100 d-none d-lg-block" ></div>
            <div class="bg-dark w-100 d-lg-none"></div>
          </div>
