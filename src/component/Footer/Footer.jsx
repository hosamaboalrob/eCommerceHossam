...
const tweetList = [
    {
        iconName: 'icofont-twitter',
        desc: <p>hosam abo alrob <a href="#">@ShopCart Greetings! </a> Grab your item, 50% Big Sale Offer !!</p>,
    },
    {
        iconName: 'icofont-twitter',
        desc: <p>hosam abo alrob <a href="#">@ShopCart </a> Grab your item, 50% Big Sale Offer !!</p>,
    },
]
                          ...
                          <ul className='lab-ul social-icons'>
                            {
                              socialList.map((val,i)=>(
                                 <li key={i}>
                                   <a href='#' className={val.iconName}><i className={val.iconName}>{val.text}</i></a>
